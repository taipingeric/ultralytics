...
class BAM(nn.Module):
    ...
    def __init__(self, channel, reduction=16,dia_val=2):
        super().__init__()
        self.ca=BAMChannelAttention(channel=channel,reduction=reduction)
        self.sa=BAMSpatialAttention(channel=channel,reduction=reduction,dia_val=dia_val)
